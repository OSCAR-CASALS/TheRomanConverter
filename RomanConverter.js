...
class Converter extends React.Component{
    ...
    render(){
        return(<div style={{backgroundColor: "rgba(105, 105, 105, 0.5)", color: "yellow", padding: "8%"}}>
            ...
            <h3>Result:</h3> <p style={{overflowWrap: "break-word", fontWeight: "bold", fontSize: "large", padding: "2vw", borderStyle: "solid", borderColor: "yellow", backgroundColor: "rgb(80, 80, 80)"}}>{this.state.Output}</p>
        </div>);
    }
}
